...
NOTE: También puede configurar el sistema con el link:../primer/exploring-grid-manager.html["Administrador de grid"] o la link:overview-of-installation-rest-apis.html["API de instalación"].
