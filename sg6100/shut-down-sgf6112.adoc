...
summary: Apague el dispositivo para realizar las tareas de mantenimiento del hardware. 
---
...
Para evitar interrupciones del servicio, apague el aparato durante un periodo de mantenimiento programado cuando se prevean períodos de interrupción del servicio.
