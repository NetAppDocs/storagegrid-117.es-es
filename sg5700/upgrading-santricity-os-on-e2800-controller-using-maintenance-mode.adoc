...
* Debe colocar la controladora E5700SG en link:../maintain/placing-appliance-into-maintenance-mode.html["modo de mantenimiento"], Que interrumpe la conexión a la controladora E2800.
+
...
.Pasos
. Confirme que el aparato está en link:../maintain/placing-appliance-into-maintenance-mode.html["modo de mantenimiento"].
...
IMPORTANT: La NVSRAM es específica del dispositivo StorageGRID. No utilice la descarga de NVSRAM estándar.
