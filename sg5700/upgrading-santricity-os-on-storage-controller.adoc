...
Consulte la https://["Herramienta de matriz de interoperabilidad de NetApp (IMT)"^] para determinar qué versión debe usar.

Descargue el nuevo archivo de software de sistema operativo SANtricity desde https://["Descargas de NetApp: Dispositivo de StorageGRID"^].
