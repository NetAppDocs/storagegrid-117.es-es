...
. link:../commonhardware/changing-mtu-setting.html["Modifique la configuración de MTU"] Según sea necesario para garantizar que son iguales para la interfaz de red de grid (eth0) en todos los nodos.
+
...
*** link:../sg100-1000/changing-link-configuration-of-services-appliance.html["SG100 y SG1000"]
...
NOTE: Consulte también link:../commonhardware/changing-mtu-setting.html["Cambie la configuración de MTU"].
...
Para obtener más información sobre la activación de la clonación MAC, consulte las instrucciones de link:../rhel/configuring-host-network.html["Red Hat Enterprise Linux o CentOS"] o. link:../ubuntu/configuring-host-network.html["Ubuntu o Debian"].
...
Para obtener más información sobre el uso del modo Promiscuous, consulte las instrucciones de link:../rhel/configuring-host-network.html["Red Hat Enterprise Linux o CentOS"] o. link:../ubuntu/configuring-host-network.html["Ubuntu o Debian"].
