...
* Para añadir una o dos bandejas de expansión a un dispositivo de almacenamiento SG6060, vaya a. link:../sg6000/adding-expansion-shelf-to-deployed-sg6060.html["Añada la bandeja de expansión al SG6060 implementado"].
* Para un nodo basado en software, siga las instrucciones delink:adding-storage-volumes-to-storage-nodes.html["Añadir volúmenes de almacenamiento a los nodos de almacenamiento"].
