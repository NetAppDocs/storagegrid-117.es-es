...
* Aplicación local que admite la recepción de mensajes de Simple Notification Service (Amazon SNS)
...
Si utiliza un servidor proxy no transparente, también debe hacerlo link:configuring-storage-proxy-settings.html["Configure las opciones de proxy de almacenamiento"] para permitir el envío de mensajes a puntos finales externos, como un punto final en internet.
