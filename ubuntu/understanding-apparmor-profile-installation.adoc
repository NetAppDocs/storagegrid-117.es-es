...
----
* Desactive por completo AppArmor. Para Ubuntu 9.10 o posterior, siga las instrucciones de la comunidad en línea Ubuntu: https://["Desactive AppArmor"^]. Es posible que deshabilitar AppArmor por completo no sea posible en las versiones más recientes de Ubuntu.
+
